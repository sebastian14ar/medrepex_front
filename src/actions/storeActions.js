...
export const enviarContacto = form => async dispatch => {
  try {
    const respuesta = await axios.post(
      "https://medrepexpress.com:8080/api/contact-us",
      form
    );
...
export const enviarPeticion = form => async dispatch => {
  try {
    const respuesta = await axios.post(
      "https://medrepexpress.com:8080/api/req-samples",
      form
    );
    console.log(respuesta);
  } catch (error) {
...
export const enviarInformacion = form => async dispatch => {
  try {
    const respuesta = await axios.post(
      "https://medrepexpress.com:8080/api/req-product-info",
      form
    );
    console.log(respuesta);
  } catch (error) {
...
export const enviarCompra = form => async dispatch => {
  try {
    const respuesta = await axios.post(
      "https://medrepexpress.com:8080/api/shopping-cart",
      form
    );
    console.log(respuesta);
  } catch (error) {
