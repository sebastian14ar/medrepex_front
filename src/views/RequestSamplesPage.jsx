          ...
          <div className="main-container-request">
            ...
            <section className="text-container-request">
              ...
              <p className="text-special">
                ...
                Products & “Sani-Cloth” Products... purchase a Box Online or by
                Phone or Fax and if you are not satisfied with the Product’s
                Performance, for any reason, we will refund the full purchase
                price with no return of the product required.
              </p>
              <p className="text-special">
                2. Or... Provide us with the information below by completing the
                “Required Information” and clicking “Submit”. We will send a
                free single unit sample of the product that we believe fits your
                application best.
              </p>
            </section>
            <div className="form">
